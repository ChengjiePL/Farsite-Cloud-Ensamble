...
# Simulated fire spread (arrival time heatmap)
...
# Simulated perimeters (blue dashed)
...
# Last simulated perimeter highlighted
...
# Observed perimeters (solid lines)
...
plt.tight_layout()
plt.savefig("farsite_case1_outputs.png", dpi=150, bbox_inches="tight")
plt.show()
print("Saved: farsite_case1_outputs.png")
